...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Both individual and corporate require state branch from registration:
    $state = '';
            ...
            if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
                ...
                try {
                    ...
                    if ($count > 0) {
                        ...
                        if ($type == 'individual') {
                            // Insert into wakalah (individual address NULL)
                            ...
                            $stmt_wak->execute(array($name, $email, $phone, $state, $ic_number));
...
<body class="register-body">
    <div class="register-card">
        ...
        <form action="register.php" method="POST" id="form-register">
            ...
            <!-- Shared Field: State Branch & Password -->
            <div class="form-group" style="margin-bottom: 1rem;">
                <label class="form-label" for="reg_state">Select State Branch office</label>
                <select name="state" id="reg_state" class="form-select" required>
